...
vmatch -q inputs/ATHILA_PBSjunction -complete -h 3 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PBS_EXCEPT4n8.vmatch

vmatch -q inputs/ATHILA_PPTjunction -complete -h 4 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PPT.vmatch

vmatch -q inputs/ATHILA_PBSjunction_ATHILA4 -complete -h 3 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PBS_ATHILA4.vmatch

vmatch -q inputs/ATHILA_PBSjunction_ATHILA8 -complete -h 3 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PBS_ATHILA8.vmatch

echo "STEP 1: DONE";

# STEP 2: PREPARE THE ABOVE VMATCH OUTPUTS FOR THE BEDTOOLS WINDOW STEP 

Rscript scripts/vmatch1_2_bed1.R $1.PBS_EXCEPT4n8.vmatch $1.PBS_EXCEPT4n8.vmatch_FULL_D.bed $1.PBS_EXCEPT4n8.vmatch_FULL_P.bed

Rscript scripts/vmatch1_2_bed1.R $1.PPT.vmatch $1.PPT.vmatch_FULL_D.bed $1.PPT.vmatch_FULL_P.bed

Rscript scripts/vmatch1_2_bed1.R $1.PBS_ATHILA4.vmatch $1.PBS_ATHILA4.vmatch_FULL_D.bed $1.PBS_ATHILA4.vmatch_FULL_P.bed

Rscript scripts/vmatch1_2_bed1.R $1.PBS_ATHILA8.vmatch $1.PBS_ATHILA8.vmatch_FULL_D.bed $1.PBS_ATHILA8.vmatch_FULL_P.bed

cat $1.PBS_EXCEPT4n8.vmatch_FULL_D.bed $1.PBS_ATHILA4.vmatch_FULL_D.bed $1.PBS_ATHILA8.vmatch_FULL_D.bed > $1.PBS.vmatch_FULL_D.bed

Rscript scripts/unique_pbs.R $1.PBS.vmatch_FULL_D.bed $1.PBS.vmatch_FULL_D_UNIQUE.bed

cat $1.PBS_EXCEPT4n8.vmatch_FULL_P.bed $1.PBS_ATHILA4.vmatch_FULL_P.bed $1.PBS_ATHILA8.vmatch_FULL_P.bed > $1.PBS.vmatch_FULL_P.bed
...
# D 
bedtools window -a $1.PBS.vmatch_FULL_D_UNIQUE.bed -b $1.PPT.vmatch_FULL_D.bed -l 0 -r $2 > $1.PBS_2_PPT_FULL_D_r10k.txt

bedtools window -a $1.PBS.vmatch_FULL_D_UNIQUE.bed -b $1.PPT.vmatch_FULL_D.bed -l 0 -r $2 -v > $1.PBS_2_PPT_FULL_D_r10k_v.txt

bedtools window -a $1.PPT.vmatch_FULL_D.bed -b $1.PBS.vmatch_FULL_D_UNIQUE.bed -l $2 -r 0 -v > $1.PPT_2_PBS_FULL_D_l10k_v.txt

# P 
bedtools window -a $1.PPT.vmatch_FULL_P.bed -b $1.PBS.vmatch_FULL_P_UNIQUE.bed -l 0 -r $2 > $1.PPT_2_PBS_FULL_P_r10k.txt

bedtools window -a $1.PPT.vmatch_FULL_P.bed -b $1.PBS.vmatch_FULL_P_UNIQUE.bed -l 0 -r $2 -v > $1.PPT_2_PBS_FULL_P_r10k_v.txt

bedtools window -a $1.PBS.vmatch_FULL_P_UNIQUE.bed -b $1.PPT.vmatch_FULL_P.bed -l $2 -r 0 -v > $1.PBS_2_PPT_FULL_P_l10k_v.txt
...
cat $1.PBS.vmatch_FULL_D_UNIQUE.bed $1.PPT.vmatch_FULL_D.bed > $1.OLIGOMERS_PBS_N_PPT_FULL_D_INTERSECT.bed

cat $1.PBS.vmatch_FULL_P_UNIQUE.bed $1.PPT.vmatch_FULL_P.bed > $1.OLIGOMERS_PBS_N_PPT_FULL_P_INTERSECT.bed
...
vmatch -q inputs/ATHILA_PBSjunction -complete -h 20 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_EXCEPT4n8.vmatch

vmatch -q inputs/ATHILA_PPTjunction -complete -h 20 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PPT.vmatch

vmatch -q inputs/ATHILA_PBSjunction_ATHILA4 -complete -h 20 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_ATHILA4.vmatch

vmatch -q inputs/ATHILA_PBSjunction_ATHILA8 -complete -h 20 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_ATHILA8.vmatch
...
Rscript scripts/vmatch_fl_blast.R $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_LENGTH.txt $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_EXCEPT4n8.vmatch $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_ATHILA4.vmatch $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS_ATHILA8.vmatch ${12} ${13} $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PPT.vmatch ${14} ${15} ${10} $1.D_5LTR_BLAST_NONOVERLAPPING.bed $1.D_3LTR_BLAST_NONOVERLAPPING.bed $1.D_INTERNAL_BLAST_NONOVERLAPPING.bed $1.P_5LTR_BLAST_NONOVERLAPPING.bed $1.P_3LTR_BLAST_NONOVERLAPPING.bed $1.P_INTERNAL_BLAST_NONOVERLAPPING.bed
...
vmatch -q inputs/ATHILA_PBSjunction -complete -h 5 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_EXCEPT4n8.vmatch
...
vmatch -q inputs/ATHILA_PBSjunction_ATHILA4 -complete -h 5 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA4.vmatch

vmatch -q inputs/ATHILA_PBSjunction_ATHILA8 -complete -h 5 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA8.vmatch

Rscript scripts/vmatch_solo.R $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_EXCEPT4n8.vmatch $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_EXCEPT4n8.txt
...
Rscript scripts/vmatch_solo.R $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA4.vmatch $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA4.txt

Rscript scripts/vmatch_solo.R $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA8.vmatch $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA8.txt

cat $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_EXCEPT4n8.txt $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PPT.txt $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA4.txt $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS_ATHILA8.txt > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TO_DELETE_PBSPPT.txt
...
Rscript scripts/hmm_domtbl_analysis.R $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_HMM_AA.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_IDs.txt ${17}_NAME_AND_LENGTH.txt $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_COUNT_TABLE.txt $1.DP_5LTR_BLAST_TOGETHER_LENGTH.txt ${10}_ $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_D_HMM_BED.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_P_HMM_BED.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_HMMTABLE.txt
