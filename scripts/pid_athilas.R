...
hist(ltr53_pid1$perc_ident1, breaks=100, xlim=c(0,100), ylim=c(0,9), main='Percentage Identity (PID1) of Full-length Elements',
...
hist(ltr53_pid2$perc_ident2, breaks=100, xlim=c(0,100), ylim=c(0,9), main='Percentage Identity (PID2) of Full-length Elements',
     xlab="Percentage Identity", ylab="Frequency", col=1)
abline(v=mean(ltr53_pid2$perc_ident2), col='red', lty=2, lwd=2)
dev.off()

png(as.character(input9))
hist(ltr53_pid3$perc_ident3, breaks=100, xlim=c(0,100), ylim=c(0,9), main='Percentage Identity (PID3) of Full-length Elements',
     xlab="Percentage Identity", ylab="Frequency", col=1)
abline(v=mean(ltr53_pid3$perc_ident3), col='red', lty=2, lwd=2)
dev.off()

png(as.character(input10))
hist(ltr53_pid4$perc_ident4, breaks=100, xlim=c(0,100), ylim=c(0,9), main='Percentage Identity (PID4) of Full-length Elements',
     xlab="Percentage Identity", ylab="Frequency", col=1)
