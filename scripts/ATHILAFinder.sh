...
echo "BLAST SOLO-LTR Coverage (Minimum value): ${16}";

echo "ORF HMM DATABASE: ${17}";
...
vmatch -q ATHILA_PBSjunction -complete -h 2 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PBS.vmatch

vmatch -q ATHILA_PPTjunction -complete -h 2 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1 > $1.PPT.vmatch

echo "STEP 1: DONE";

# STEP 2: PREPARE THE ABOVE VMATCH OUTPUTS FOR THE BEDTOOLS WINDOW STEP 

Rscript /mnt/RAID/method/ATHILAFinder/vmatch1_2_bed1.R $1.PBS.vmatch $1.PBS.vmatch_FULL_D.bed $1.PBS.vmatch_FULL_P.bed 

Rscript /mnt/RAID/method/ATHILAFinder/vmatch1_2_bed1.R $1.PPT.vmatch $1.PPT.vmatch_FULL_D.bed $1.PPT.vmatch_FULL_P.bed

Rscript /mnt/RAID/method/ATHILAFinder/unique_pbs.R $1.PBS.vmatch_FULL_D.bed $1.PBS.vmatch_FULL_D_UNIQUE.bed 

Rscript /mnt/RAID/method/ATHILAFinder/unique_pbs.R $1.PBS.vmatch_FULL_P.bed $1.PBS.vmatch_FULL_P_UNIQUE.bed

Rscript /mnt/RAID/method/ATHILAFinder/unique_pbs.R $1.PPT.vmatch_FULL_D.bed $1.PPT.vmatch_FULL_D_UNIQUE.bed

Rscript /mnt/RAID/method/ATHILAFinder/unique_pbs.R $1.PPT.vmatch_FULL_P.bed $1.PPT.vmatch_FULL_P_UNIQUE.bed
...
Rscript /mnt/RAID/method/ATHILAFinder/vmatch1bed2_2_intersect.R $1.PBS_2_PPT_FULL_D_r10k.txt $1.PBS_2_PPT_FULL_D_r10k_v.txt $1.PPT_2_PBS_FULL_D_l10k_v.txt $1.PBS_2_PPT_D_EVERYTHING.txt $1.PBS_2_PPT_D_DISTANCE.txt $3 $4 $1.PBS_2_PPT_D_INTERSECT.bed $1.PBS_2_PPT_D_REJECTED.bed

Rscript /mnt/RAID/method/ATHILAFinder/vmatch1bed2_2_intersect.R $1.PPT_2_PBS_FULL_P_r10k.txt $1.PPT_2_PBS_FULL_P_r10k_v.txt $1.PBS_2_PPT_FULL_P_l10k_v.txt $1.PPT_2_PBS_P_EVERYTHING.txt $1.PPT_2_PBS_P_DISTANCE.txt $3 $4 $1.PPT_2_PBS_P_INTERSECT.bed $1.PPT_2_PBS_P_REJECTED.bed
...
python3 /mnt/RAID/method/ATHILAFinder/rmv_intersect.py $1.INTERSECT_D_2_P.txt $1.PBS_2_PPT_D_INTERSECT.bed $1.PBS_2_PPT_D_INTERSECT_NEW.bed

# P
bedtools intersect -a $1.PPT_2_PBS_P_INTERSECT.bed -b $1.OLIGOMERS_PBS_N_PPT_FULL_D_INTERSECT.bed -wa > $1.INTERSECT_P_2_D.txt

python3 /mnt/RAID/method/ATHILAFinder/rmv_intersect.py $1.INTERSECT_P_2_D.txt $1.PPT_2_PBS_P_INTERSECT.bed $1.PPT_2_PBS_P_INTERSECT_NEW.bed
...
python3 /mnt/RAID/method/ATHILAFinder/keep_unique_seqs.py $1.ALL.PBSNPPT_D_POTENTIAL_STARTS.fasta $1.ALL.PBSNPPT_D_POTENTIAL_STARTS_UNIQUE.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/keep_unique_seqs.py $1.ALL.PBSNPPT_D_POTENTIAL_ENDS.fasta $1.ALL.PBSNPPT_D_POTENTIAL_ENDS_UNIQUE.fasta

# P
bedtools getfasta -fi $1 -bed $1.PPTNPBS_P_OUTSIDE_INTERNAL_CLEAN.bed -fo $1_ATHILA_OUTSIDE_P_ELEMENTS.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto.py $1_ATHILA_OUTSIDE_P_ELEMENTS.fasta

bedtools getfasta -fi $1 -bed $1.ALL.PBSNPPT_P_EXTENDED_INTERNAL_CLEAN.bed -fo $1_ATHILA_EXTENDED_P_ELEMENTS.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto.py $1_ATHILA_EXTENDED_P_ELEMENTS.fasta

bedtools getfasta -fi $1 -bed $1.ALL.PBSNPPT_P_POTENTIAL_STARTS.bed -name -fo $1.ALL.PBSNPPT_P_POTENTIAL_STARTS.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto.py $1.ALL.PBSNPPT_P_POTENTIAL_STARTS.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/keep_unique_seqs.py $1.ALL.PBSNPPT_P_POTENTIAL_STARTS.fasta_sl.fasta $1.ALL.PBSNPPT_P_POTENTIAL_STARTS.fasta_sl_UNIQUE.fasta

bedtools getfasta -fi $1 -bed $1.ALL.PBSNPPT_P_POTENTIAL_ENDS.bed -name -fo $1.ALL.PBSNPPT_P_POTENTIAL_ENDS.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto.py $1.ALL.PBSNPPT_P_POTENTIAL_ENDS.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/keep_unique_seqs.py $1.ALL.PBSNPPT_P_POTENTIAL_ENDS.fasta_sl.fasta $1.ALL.PBSNPPT_P_POTENTIAL_ENDS.fasta_sl_UNIQUE.fasta
...
Rscript /mnt/RAID/method/ATHILAFinder/get_ltr_internal_bed.R $1.ALL.PBSNPPT_D_EXTENDED_INTERNAL_CLEAN.bed $1.D_FULLLENGTH.bed $1.D_5LTR.bed $1.D_3LTR.bed $1.D_INTERNAL.bed $1.ALL.PBSNPPT_P_EXTENDED_INTERNAL_CLEAN.bed $1.P_FULLLENGTH.bed $1.P_5LTR.bed $1.P_3LTR.bed $1.P_INTERNAL.bed
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_5LTR.fasta

bedtools getfasta -fi $1 -bed $1.P_3LTR.bed -fo $1.P_3LTR.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_3LTR.fasta

bedtools getfasta -fi $1 -bed $1.P_INTERNAL.bed -fo $1.P_INTERNAL.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_INTERNAL.fasta
...
Rscript /mnt/RAID/method/ATHILAFinder/fix_names.R $1.DP_FULLLENGTH.bed ${10} $1.DP_FULLLENGTH_RENAME.txt $1.DP_FULLLENGTH_RENAMED.bed $1.D_FULLLENGTH_NEW_PLUS_TSD_LEFTV2.bed $1.P_FULLLENGTH_NEW_PLUS_TSD_LEFTV2.bed $1.D_FULLLENGTH_NEW_PLUS_TSD_RIGHTV3.bed $1.P_FULLLENGTH_NEW_PLUS_TSD_RIGHTV3.bed $1.DP_5LTR.bed $1.DP_5LTR_RENAME.txt $1.DP_5LTR_RENAMED.bed $1.DP_3LTR.bed $1.DP_3LTR_RENAME.txt $1.DP_3LTR_RENAMED.bed $1.DP_INTERNAL.bed $1.DP_INTERNAL_RENAME.txt $1.DP_INTERNAL_RENAMED.bed

perl /mnt/RAID/method/ATHILAFinder/rename.pl $1.DP_FULLLENGTH_RENAME.txt $1.DP_FULLLENGTH.fasta > $1.DP_FULLLENGTH_RENAMED.fasta

perl /mnt/RAID/method/ATHILAFinder/rename.pl $1.DP_5LTR_RENAME.txt $1.DP_5LTR.fasta > $1.DP_5LTR_RENAMED.fasta

perl /mnt/RAID/method/ATHILAFinder/rename.pl $1.DP_3LTR_RENAME.txt $1.DP_3LTR.fasta > $1.DP_3LTR_RENAMED.fasta

perl /mnt/RAID/method/ATHILAFinder/rename.pl $1.DP_INTERNAL_RENAME.txt $1.DP_INTERNAL.fasta > $1.DP_INTERNAL_RENAMED.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH_BLAST_NONOVERLAPPING.fasta
...
cat $1.DP_FULLLENGTH_RENAMED.bed $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.bed > $1.DP_FULLLENGTH_BLAST_TOGETHER.bed

cat $1.DP_FULLLENGTH_RENAMED.fasta $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_TOGETHER.fasta

mkvtree -dna -pl 5 -allout -v -db $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta

vmatch -q ATHILA_PBSjunction -complete -h 8 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS.vmatch

vmatch -q ATHILA_PPTjunction -complete -h 8 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.fasta > $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PPT.vmatch
...
Rscript /mnt/RAID/method/ATHILAFinder/vmatch_fl_blast.R $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_LENGTH.txt $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PBS.vmatch ${12} ${13} $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING_PPT.vmatch ${14} ${15} ${10} $1.D_5LTR_BLAST_NONOVERLAPPING.bed $1.D_3LTR_BLAST_NONOVERLAPPING.bed $1.D_INTERNAL_BLAST_NONOVERLAPPING.bed $1.P_5LTR_BLAST_NONOVERLAPPING.bed $1.P_3LTR_BLAST_NONOVERLAPPING.bed $1.P_INTERNAL_BLAST_NONOVERLAPPING.bed

bedtools getfasta -fi $1 -bed $1.D_5LTR_BLAST_NONOVERLAPPING.bed -name -fo $1.D_5LTR_BLAST_NONOVERLAPPING.fasta

bedtools getfasta -fi $1 -bed $1.D_3LTR_BLAST_NONOVERLAPPING.bed -name -fo $1.D_3LTR_BLAST_NONOVERLAPPING.fasta

bedtools getfasta -fi $1 -bed $1.D_INTERNAL_BLAST_NONOVERLAPPING.bed -name -fo $1.D_INTERNAL_BLAST_NONOVERLAPPING.fasta

bedtools getfasta -fi $1 -bed $1.P_5LTR_BLAST_NONOVERLAPPING.bed -name -fo $1.P_5LTR_BLAST_NONOVERLAPPING.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_5LTR_BLAST_NONOVERLAPPING.fasta

bedtools getfasta -fi $1 -bed $1.P_3LTR_BLAST_NONOVERLAPPING.bed -name -fo $1.P_3LTR_BLAST_NONOVERLAPPING.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_3LTR_BLAST_NONOVERLAPPING.fasta

bedtools getfasta -fi $1 -bed $1.P_INTERNAL_BLAST_NONOVERLAPPING.bed -name -fo $1.P_INTERNAL_BLAST_NONOVERLAPPING.fasta

python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_INTERNAL_BLAST_NONOVERLAPPING.fasta

cat $1.D_5LTR_BLAST_NONOVERLAPPING.fasta $1.P_5LTR_BLAST_NONOVERLAPPING.fasta_sl.fasta > $1.DP_5LTR_BLAST_NONOVERLAPPING.fasta

cat $1.D_3LTR_BLAST_NONOVERLAPPING.fasta $1.P_3LTR_BLAST_NONOVERLAPPING.fasta_sl.fasta > $1.DP_3LTR_BLAST_NONOVERLAPPING.fasta

cat $1.D_INTERNAL_BLAST_NONOVERLAPPING.fasta $1.P_INTERNAL_BLAST_NONOVERLAPPING.fasta_sl.fasta > $1.DP_INTERNAL_BLAST_NONOVERLAPPING.fasta

cat $1.D_5LTR_BLAST_NONOVERLAPPING.bed $1.P_5LTR_BLAST_NONOVERLAPPING.bed > $1.DP_5LTR_BLAST_NONOVERLAPPING.bed

cat $1.D_3LTR_BLAST_NONOVERLAPPING.bed $1.P_3LTR_BLAST_NONOVERLAPPING.bed > $1.DP_3LTR_BLAST_NONOVERLAPPING.bed

cat $1.D_INTERNAL_BLAST_NONOVERLAPPING.bed $1.P_INTERNAL_BLAST_NONOVERLAPPING.bed > $1.DP_INTERNAL_BLAST_NONOVERLAPPING.bed

sort -k1,1V $1.DP_INTERNAL_BLAST_NONOVERLAPPING.bed > $1.DP_INTERNAL_BLAST_NONOVERLAPPING_SORTED.bed

cat $1.DP_INTERNAL_RENAMED.fasta $1.DP_INTERNAL_BLAST_NONOVERLAPPING.fasta > $1.DP_INTERNAL_BLAST_TOGETHER.fasta

cat $1.DP_5LTR_RENAMED.fasta $1.DP_5LTR_BLAST_NONOVERLAPPING.fasta > $1.DP_5LTR_BLAST_TOGETHER.fasta

cat $1.DP_3LTR_RENAMED.fasta $1.DP_3LTR_BLAST_NONOVERLAPPING.fasta > $1.DP_3LTR_BLAST_TOGETHER.fasta

cat $1.DP_5LTR_BLAST_TOGETHER.fasta $1.DP_3LTR_BLAST_TOGETHER.fasta > $1.DP_ALLLTR_BLAST_TOGETHER.fasta

cat $1.DP_5LTR_RENAMED.bed $1.DP_5LTR_BLAST_NONOVERLAPPING.bed > $1.DP_5LTR_BLAST_TOGETHER.bed

cat $1.DP_3LTR_RENAMED.bed $1.DP_3LTR_BLAST_NONOVERLAPPING.bed > $1.DP_3LTR_BLAST_TOGETHER.bed

cat $1.DP_INTERNAL_RENAMED.bed $1.DP_INTERNAL_BLAST_NONOVERLAPPING.bed > $1.DP_INTERNAL_BLAST_TOGETHER.bed
...
awk 'BEGIN{FS="[> ]"} /^>/{val=$2;next}  {print val"\t"length($0)}' $1.DP_OUR_LTR_RENAMED.fasta > $1.DP_OUR_LTR_RENAMED_LENGTH.txt
...
blastall -p blastn -i $1.DP_OUR_LTR_RENAMED.fasta -d $1_all_fulllength_masked.fasta -e 10e-180 -F F -a 7 -m 8 > $1.ALL_OUR_LTR_AGAINST_MG_BLAST_OUTPUT_SOLO_LTR.txt

Rscript /mnt/RAID/method/ATHILAFinder/blast_output_analysis_soloLTR.R $1.ALL_OUR_LTR_AGAINST_MG_BLAST_OUTPUT_SOLO_LTR.txt $1.DP_OUR_LTR_RENAMED_LENGTH.txt ${16} ${10} $1.D_SOLO_LTR_BLAST_NONOVERLAPPING.bed $1.D_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.bed $1.P_SOLO_LTR_BLAST_NONOVERLAPPING.bed $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.bed $1.D_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_LEFTV2.bed $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_LEFTV2.bed $1.D_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_RIGHTV3.bed $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_RIGHTV3.bed
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_SOLO_LTR_BLAST_NONOVERLAPPING.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta
...
vmatch -q ATHILA_PBSjunction -complete -h 5 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS.vmatch

vmatch -q ATHILA_PPTjunction -complete -h 5 -d -p -s -v -showdesc 100 -noevalue -noidentity -noscore $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS.fasta > $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PPT.vmatch

Rscript /mnt/RAID/method/ATHILAFinder/vmatch_solo.R $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS.vmatch $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PBS.txt

Rscript /mnt/RAID/method/ATHILAFinder/vmatch_solo.R $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PPT.vmatch $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_PPT.txt
...
python3 /mnt/RAID/method/ATHILAFinder/remove_prime_solo.py $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING.fasta $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TO_DELETE_PBSPPT.txt $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_CLEAR_PBSPPT_ml.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH_NEW_PLUS_TSD_LEFTV2.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH_NEW_PLUS_TSD_RIGHTV3.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH_BLAST_NONOVERLAPPING_PLUS_TSD_LEFTV2.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_FULLLENGTH_BLAST_NONOVERLAPPING_PLUS_TSD_RIGHTV3.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_LEFTV2.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.P_SOLO_LTR_BLAST_NONOVERLAPPING_PLUS_TSD_RIGHTV3.fasta
...
Rscript /mnt/RAID/method/ATHILAFinder/hmm_domtbl_analysis.R $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_HMM_AA.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_IDs.txt ${17}_NAME_AND_LENGTH.txt $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_COUNT_TABLE.txt $1.DP_5LTR_BLAST_TOGETHER_LENGTH.txt ${10}_ $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_D_HMM_BED.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_P_HMM_BED.bed $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_HMMTABLE.txt
...
python3 /mnt/RAID/method/ATHILAFinder/revcom_auto2.py $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_P_HMM_FASTA.fasta
...
python3 /mnt/RAID/method/ATHILAFinder/translate_dna.py $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_DP_HMM_FASTA.fasta
...
Rscript /mnt/RAID/method/ATHILAFinder/pid_athilas.R $1.DP_5LTR_BLAST_TOGETHER.fasta_table.txt $1.DP_3LTR_BLAST_TOGETHER.fasta_table.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID1_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID2_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID3_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID4_TABLE.txt $1_pid1.png $1_pid2.png $1_pid3.png $1_pid4.png

echo "STEP 20: DONE";

# STEP 21: SUMMARY TABLES

Rscript /mnt/RAID/method/ATHILAFinder/summary_table.R $1.DP_FULLLENGTH_RENAMED.bed $1.DP_5LTR_RENAMED.bed $1.DP_3LTR_RENAMED.bed $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.bed $1.DP_5LTR_BLAST_NONOVERLAPPING.bed $1.DP_3LTR_BLAST_NONOVERLAPPING.bed $1.DP_FULLLENGTH_BLAST_TOGETHER_PID1_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID2_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID3_TABLE.txt $1.DP_FULLLENGTH_BLAST_TOGETHER_PID4_TABLE.txt $1.DP_SOLO_LTR_BLAST_NONOVERLAPPING_CLEAR_PBSPPT.bed $1.DP_ULTIMATE_TSD_TABLE.txt ${10} $1.DP_FULLLENGTH_AND_SOLO_SUMMARY_TABLE.txt $1.DP_INTERNAL_BLAST_TOGETHER.fasta.ORF300_SL.fasta.hmmscanned.E001incE001.domtbl_HMMTABLE.txt $1.DP_FULLLENGTH_AND_HMM_SUMMARY_TABLE_ALLPID.txt
...
b=($(wc $1.DP_FULLLENGTH_BLAST_NONOVERLAPPING.bed))
