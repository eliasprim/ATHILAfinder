...
write.table(ult_tsd_tab_solo, input10, sep = "\t", row.names = F, quote= F, col.names = F)


clear_tsd_tab_solo=ult_tsd_tab_solo[which(ult_tsd_tab_solo$same_tsd=="Y"),]


write.table(clear_tsd_tab_solo, input11, sep = "\t", row.names = F, quote= F, col.names = F)


no_tsd_tab_solo=ult_tsd_tab_solo[which(ult_tsd_tab_solo$same_tsd=="N"),]


write.table(no_tsd_tab_solo, input12, sep = "\t", row.names = F, quote= F, col.names = F)